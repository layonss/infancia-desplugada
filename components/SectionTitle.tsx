...
export default function SectionTitle({
  ...
  return (
    <div className={`space-y-4 ${centered ? "text-center" : "text-left"}`}>
      <h2
        className={`text-3xl md:text-5xl font-black tracking-tight transition-colors duration-300 ${light
            ? "text-white"
      ...
      {subtitle && (
        <p
          className={`max-w-2xl ${centered ? "mx-auto" : ""} text-base md:text-lg leading-relaxed transition-colors duration-300 ${light
              ? "text-indigo-100/90"
